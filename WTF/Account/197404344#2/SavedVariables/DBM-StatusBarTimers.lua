...
DBT_AllPersistentOptions = {
	["Default"] = {
		["AddOnSkins"] = {
			...
			["TextColorG"] = 1,
			["KeepBars"] = true,
			["HugeTimerX"] = 54.99953460693359,
			["HugeTimerY"] = -182.2218017578125,
			["HugeAlpha"] = 1,
			["ColorByType"] = true,
			["IconLeft"] = true,
			["HugeWidth"] = 200,
