				...
				["Feral DPS (IV)"] = {
					...
					["lists"] = {
						...
						["cat"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "glyph.omen_of_clarity.enabled & ! buff.clearcasting.up & ( target.outside2 || buff.berserk.up & ff_during_berserk || ! buff.berserk.up & energy.current < 87 ) & ( ! rip_now || energy.current < action.rip.spend )",
								["action"] = "faerie_fire_feral",
							}, -- [3]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "! debuff.mangle.up & ttd > 1",
								["action"] = "mangle_cat",
							}, -- [9]
							{
								["enabled"] = true,
								["criteria"] = "buff.clearcasting.up & ! debuff.bleed.up & ttd >= 10",
								["action"] = "rake",
							}, -- [10]
							{
								["enabled"] = true,
								["criteria"] = "! up & ! buff.clearcasting.up & ( should_rake || ! debuff.bleed.up ) & ttd > 9",
								["action"] = "rake",
							}, -- [11]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "excess_e >= action.shred.spend || buff.clearcasting.up || buff.berserk.up || ( cooldown.faerie_fire_feral.remains <= 1 & energy.current > 77 || energy.current = 100 ) || buff.savage_roar.remains != buff.savage_roar.remains || debuff.mangle.remains != debuff.mangle.remains || debuff.rake.remains != debuff.rake.remains || debuff.rip.remains != debuff.rip.remains",
								["action"] = "shred",
							}, -- [15]
						},
						["precombat"] = {
						...
						["cat_aoe"] = {
							{
								["enabled"] = true,
								["criteria"] = "glyph.omen_of_clarity.enabled & ! buff.clearcasting.up & ( buff.berserk.up & ff_during_berserk || ! buff.berserk.up & energy.current < 87 )",
								["action"] = "faerie_fire_feral",
							}, -- [1]
							{
								["use_off_gcd"] = 1,
							...
							{
								["enabled"] = true,
								["criteria"] = "( set_bonus.idol_of_the_corruptor = 1 || set_bonus.idol_of_mutilation = 1 ) & combo_points.current = 0 & buff.savage_roar.remains <= 1 & ( ttd > buff.savage_roar.remains + 1 + latency ) & ! wait_for_ff",
								["action"] = "mangle_cat",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "set_bonus.idol_of_mutilation = 1 & combo_points.current = 0 & buff.savage_roar.remains <= 1 & ( ttd > buff.savage_roar.remains + 1 + latency ) & ! wait_for_ff",
								["action"] = "shred",
							}, -- [6]
							{
								["enabled"] = true,
