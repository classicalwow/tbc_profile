...
[G30.0,34.3 Shadowmoon Valley]Hang out in this area to attack *Infernal Attackers* as they spawn. You'll need to do significant damage to get credit! Complete [QC10595].
...
[G29.0,20.4 Shadowmoon Valley]Kill and loot *Doctor Maleficus* and then loot *The Doctor's Strongbox* to complete [QC10611].
Turn in [QT10611 The Art of Fel Reaver Maintenance].\\Accept [QA10613 The Fel and the Furious].
[G27.8,19.8 Shadowmoon Valley]
Use any of the *Fel Reaver Control Consoles.* If you have a pet, you may need to dismiss it in order for this to work. Kill *Deathforged Infernals* using the *Destroy Deathforged Infernal* button to complete [QC10613]. *As of TBC launch this is bugged so be aware of the following note!!* Do your best to kill most of the stuff attacking your Reaver or they will all decide to randomly attack and kill you at the console and you will need to rez *at the Spirit Healer!*
...
[G41.1,60.8 Shadowmoon Valley]Kill all of the *Dark Conclave Ritualists* and then use the *Staff of Parshah* in your inventory to complete [QC10808].
Hearth to [H Shadowmoon Village].
...
*CONGRATULATIONS ON REACHING LEVEL 70!!!!!* Thank you so much for using *Flymolo's Outland Leveling Guide!!*
