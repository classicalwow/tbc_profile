...
f.TitleText:SetText(L["Ease Addon Controller Profiles"])
...
local detailframe = WW:Frame('U1ProfileDetailFrame', f, "BackdropTemplate"):Size(220, 170):TL("$parent", 'TR', -11, -14)
