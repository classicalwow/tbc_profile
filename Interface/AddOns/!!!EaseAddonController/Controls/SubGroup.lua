...
local creator = function()
    ...
    group.border = group:Frame(nil, "BackdropTemplate"):TL(-1, 2-18-CTL_LINESPACE+2):BR(4,-2-CTL_LINESPACE+4):Backdrop(nil,UUI.Tex'TuiBlank',1):SetBackdropBorderColor(.3,.3,.3):un()
    return group:un();
end
