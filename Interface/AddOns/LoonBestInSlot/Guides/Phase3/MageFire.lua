local spec = LBIS:RegisterSpec(LBIS.L["Mage"], LBIS.L["Fire"], "3")
...
LBIS:AddItem(spec, "32589", LBIS.L["Neck"], "BIS") --Hellfire-Encased Pendant
...
LBIS:AddItem(spec, "29270", LBIS.L["Off Hand"], "Alt") --Flametongue Seal
