local spec = LoonBestInSlot:RegisterSpec("Priest", "Holy", "4")
...
LoonBestInSlot:AddItem(spec, "33587", "Gloves", "Light-Blessed Bonds", "BIS")
...
LoonBestInSlot:AddItem(spec, "33325", "OH", "Voodoo Shaker", "Alt")
