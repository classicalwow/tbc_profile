local spec = LBIS:RegisterSpec(LBIS.L["Hunter"], LBIS.L["Survival"], "4")

LBIS:AddItem(spec, "31003", LBIS.L["Head"], "BIS") --Gronnstalker's Helmet
...
LBIS:AddItem(spec, "28791", LBIS.L["Ring"], "Alt") --Ring of the Recalcitrant
