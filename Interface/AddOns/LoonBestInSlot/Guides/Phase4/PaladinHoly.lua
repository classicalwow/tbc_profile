local spec = LoonBestInSlot:RegisterSpec("Paladin", "Holy", "4")
...
LoonBestInSlot:AddItem(spec, "33446", "Belt", "Girdle of Stromgarde's Hope", "BIS")
...
LoonBestInSlot:AddItem(spec, "33502", "Libram", "Libram of Mending", "Alt")
