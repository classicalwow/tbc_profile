local spec = LoonBestInSlot:RegisterSpec("Priest", "Shadow", "1")
...
LoonBestInSlot:AddItem(spec, "28799", "Belt", "Belt of Divine Inspiration", "BIS")
...
LoonBestInSlot:AddItem(spec, "31693", "Neck", "Natasha's Arcane Filament", "Alt")
