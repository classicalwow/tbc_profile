...
local function showHeaderToolTip()
  ...
  elseif NS.Options.Window.Locked then
    weizPVP_CoreTooltip:AddLine(NS.ColorsLUT["uiMouse"]:WrapTextInColorCode("Ctrl + Right-Click") .. joinString .. lockStat)
  else
    weizPVP_CoreTooltip:AddLine(NS.ColorsLUT["uiMouse"]:WrapTextInColorCode("Right-Click") .. joinString .. pinStat)
    weizPVP_CoreTooltip:AddLine(NS.ColorsLUT["uiMouse"]:WrapTextInColorCode("Ctrl + Right-Click") .. joinString .. lockStat)
  end
...
local function CoreBarInit()
  ...
  do
    ...
    -- : State Glyph
    --> Status Icon
    weizPVP_CoreBar.StatusIcon.StateGlyph:SetFont("Interface/Addons/weizPVP/Media/Fonts/WeizGlyphs.ttf", NS.Options.Frames.Header.Height - Round(NS.Options.Frames.Header.Height / 8), "OUTLINE")
    ...
    weizPVP_CoreBar.StatusIcon.StateGlyph:SetPoint("TOPLEFT", weizPVP_CoreBar, "TOPLEFT", NS.Options.Frames.BorderSize * 4, 0)
  end

  --> Title (Nearby Count)
  weizPVP_CoreBar.Title:SetFont(SM:Fetch("font", NS.Options.Frames.Header.Font), NS.Options.Frames.Header.Height - Round(NS.Options.Frames.Header.Height / 4), "OUTLINE")
  ...
  --: separator
  weizPVP_CoreBar.Separator:SetFont(SM:Fetch("font", NS.Options.Frames.Header.Font), NS.Options.Frames.Header.Height - spacer, "OUTLINE")
  ...
  weizPVP_CoreBar.StatusHeader.Highlight.grad:SetGradientAlpha("HORIZONTAL", NS.ColorsLUT[highlightColor].r, NS.ColorsLUT[highlightColor].g, NS.ColorsLUT[highlightColor].b, 0, NS.ColorsLUT[highlightColor].r, NS.ColorsLUT[highlightColor].g, NS.ColorsLUT[highlightColor].b, 0.4)
  ...
  weizPVP_CoreBar.StatusHeader.Highlight.grad2:SetGradientAlpha("HORIZONTAL", NS.ColorsLUT[highlightColor].r, NS.ColorsLUT[highlightColor].g, NS.ColorsLUT[highlightColor].b, 0.4, NS.ColorsLUT[highlightColor].r, NS.ColorsLUT[highlightColor].g, NS.ColorsLUT[highlightColor].b, 0)
  ...
  do
    ...
    weizPVP_CoreFrame.ScrollFrame:SetPoint("TOP", weizPVP_CoreFrame, "TOP", 0, -NS.Options.Frames.Header.Height + NS.Options.Frames.BorderSize)
    ...
    weizPVP_CoreFrame.ScrollFrame.ListFrame:SetPoint("TOP", weizPVP_CoreFrame, "TOP", 0, -NS.Options.Frames.Header.Height)
...
local function BuildTargetedIcon()
  ...
  weizPVP_CoreFrame.OuterIconFrame:SetPoint("BOTTOMRIGHT", weizPVP_CoreFrame, "BOTTOMRIGHT", NS.Options.Bars.RowHeight, 0)
  ...
  weizPVP_CoreFrame.TargetedIcon:SetSize(Round(NS.Options.Bars.RowHeight - (NS.Options.Bars.RowHeight / 6)), Round(NS.Options.Bars.RowHeight - (NS.Options.Bars.RowHeight / 6)))
...
function NS.CoreUI.ChangeTargetIcon()
  ...
  if NS.PlayersOnBars[GUID] then
    if weizPVP_CoreFrame:GetLeft() < 8 then
      ...
      weizPVP_CoreFrame.TargetedIcon:SetPoint("LEFT", NS.CoreUI.Bar[NS.PlayersOnBars[GUID]], "RIGHT", -(NS.Options.Frames.BorderSize), 0)
    else
      weizPVP_CoreFrame.TargetedIcon:SetRotation(0)
      weizPVP_CoreFrame.TargetedIcon:ClearAllPoints()
      weizPVP_CoreFrame.TargetedIcon:SetPoint("RIGHT", NS.CoreUI.Bar[NS.PlayersOnBars[GUID]], "LEFT", NS.Options.Frames.BorderSize, 0)
    end
...
function NS.CoreUI.CombatEnd()
  NS.CoreUI.SetStatusIconColor(NS.ColorsLUT["OutOfCombat"].r, NS.ColorsLUT["OutOfCombat"].g, NS.ColorsLUT["OutOfCombat"].b)
  C_Timer_After(
    3,
    function()
      if not InCombatLockdown() then
...
function NS.CoreUI.FlashTitleBar(color)
  if NS.ColorsLUT[color] then
    weizPVP_CoreBar.StatusHeader.Highlight.grad:SetGradientAlpha("HORIZONTAL", NS.ColorsLUT[color].r, NS.ColorsLUT[color].g, NS.ColorsLUT[color].b, 0, NS.ColorsLUT[color].r, NS.ColorsLUT[color].g, NS.ColorsLUT[color].b, 0.4)
    weizPVP_CoreBar.StatusHeader.Highlight.grad2:SetGradientAlpha("HORIZONTAL", NS.ColorsLUT[color].r, NS.ColorsLUT[color].g, NS.ColorsLUT[color].b, 0.4, NS.ColorsLUT[color].r, NS.ColorsLUT[color].g, NS.ColorsLUT[color].b, 0)
...
function NS.AutoResize()
  ...
  weizPVP_CoreFrame:SetHeight((count * (NS.Options.Bars.RowHeight + NS.Options.Bars.VerticalSpacing)) + NS.Options.Frames.Header.Height)
  SnapHeightToBars()
end
